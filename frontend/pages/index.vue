            ...
            <div class="mt-10">
              ...
              <div class="mt-6 sm:max-w-xl">
                <ul class="list-disc ml-6 text-gray-600">
                  ...
                  <li>
                    <span class="font-bold">Coupon Management</span> with Windows Authentication, role-based access, and coupon upload/assignment features.
                  </li>
                </ul>
              </div>
              <div class="mt-8">
                <NuxtLinkLocale to="/dashboard" class="inline-flex items-center rounded-md border border-transparent bg-rose-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2">
                  Go to Dashboard
                </NuxtLinkLocale>
              </div>
            </div>
