...
from app.core import security, windows_auth
...
@router.post("/windows", response_model=schemas.Token)
def login_with_windows_auth(
    *,
    db: Annotated[Session, Depends(deps.get_db)],
    user: Annotated[models.User, Depends(windows_auth.authenticate_windows_user)]
) -> Any:
    """
